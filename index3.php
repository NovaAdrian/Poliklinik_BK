...
if (!isset($_SESSION['username'])) {
    header('Location: loginpasien.php'); // Redirect ke halaman login jika belum login
    exit();
}
?>
...
<head>
  ...
  <script src="https://kit.fontawesome.com/b3f94addcf.js" crossorigin="anonymous"></script>
  <!-- Theme style -->
