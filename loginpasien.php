...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login'])) {
    ...
    $check_user = $mysqli->prepare("SELECT * FROM pasien WHERE username = ? AND password = ?");
...
<div class="login-box">
  <div class="login-logo">
    <a href="index3.php"><b>Pasien</b></a>
  </div>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <div class="social-auth-links text-center ">
        ...
        <a href="regispasien.php" class="text-center">Register a new membership</a>
    </div>
    <!-- /.login-card-body -->
  </div>
</div>
